...
const makeDesktopClerkLayer = (isDevelopment = true, events: string[] = []) => {
  const environment = DesktopEnvironment.DesktopEnvironment.of({
    ...
    userDataDirName: isDevelopment ? "t3code-treher-dev" : "t3code-treher",
...
describe("DesktopClerk", () => {
  ...
  it.effect("acquires and releases the SDK bridge with the layer", () => {
    ...
    return Effect.gen(function* () {
        ...
        [
          {
            ...
            renderer: { scheme: "treher-t3code-dev", host: "app" },
          },
        ],
      ]);
      ...
      assert.deepEqual(events, [
        "setPath:userData:/tmp/app-data/t3code-treher-dev",
        "createClerkBridge",
      ]);
  ...
  it.each([
    { isDevelopment: true, scheme: "treher-t3code-dev" },
    { isDevelopment: false, scheme: "treher-t3code" },
