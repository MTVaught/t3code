...
// Review diffs ship whole patches to the client, like checkpoint diffs do, so
// they share the checkpoint diff budget instead of a preview-sized one.
const REVIEW_DIFF_PATCH_MAX_OUTPUT_BYTES = 10_000_000;
const REVIEW_UNTRACKED_DIFF_MAX_OUTPUT_BYTES = REVIEW_DIFF_PATCH_MAX_OUTPUT_BYTES;
