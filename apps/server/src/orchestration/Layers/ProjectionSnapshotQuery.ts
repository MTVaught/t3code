...
const ProjectionThreadDbRowSchema = ProjectionThread.mapFields(
  Struct.assign({
    ...
    reviewFollowUpPaths: Schema.optional(
    ...
    execute: () =>
      sql`
        SELECT
          ...
          review_follow_up_paths_json AS "reviewFollowUpPaths",
          ...
          ([
            ...
            Effect.gen(function* () {
              ...
              const threads: ReadonlyArray<OrchestrationThread> = threadRows.map((row) => ({
                ...
                ...(row.providerMode !== undefined ? { providerMode: row.providerMode } : {}),
                branch: row.branch,
                ...
                reviewFollowUpPaths: row.reviewFollowUpPaths ?? [],
  ...
  const getThreadShellById: ProjectionSnapshotQueryShape["getThreadShellById"] = (threadId) =>
    Effect.gen(function* () {
      ...
      return Option.some({
        ...
        ...(threadRow.value.providerMode !== undefined
          ? { providerMode: threadRow.value.providerMode }
          : {}),
  ...
  const getThreadDetailByIdBounded = (
    ...
    Effect.gen(function* () {
      ...
      const thread = {
        ...
        pinOrderKey: threadRow.value.pinOrderKey ?? null,
        activeOrderKey: threadRow.value.activeOrderKey ?? null,
        reviewFollowUpPaths: threadRow.value.reviewFollowUpPaths ?? [],
        titleRegeneration: mapTitleRegeneration(threadRow.value),
        titleState: threadRow.value.titleState,
        deletedAt: null,
