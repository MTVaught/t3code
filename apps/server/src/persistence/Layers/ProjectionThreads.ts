    ...
    execute: (row) =>
      sql`
        ...
        VALUES (
          ...
          ${row.reviewFollowUpPaths == null || row.reviewFollowUpPaths.length === 0 ? null : JSON.stringify(row.reviewFollowUpPaths)},
        ...
        DO UPDATE SET
          ...
          review_follow_up_paths_json = excluded.review_follow_up_paths_json,
