...
export const ThreadComposer = memo(function ThreadComposer(props: ThreadComposerProps) {
  ...
  // snapshot so the command menu and editor see the project's set.
  const effectiveProviderStatus = useMemo(
    () =>
      selectedProviderStatus && projectMetadata
        ? {
        ...
        : selectedProviderStatus,
    [projectMetadata, selectedProviderStatus],
  );
  ...
  const composerMenu = useComposerCommandMenu({
    ...
    selectedProviderStatus: effectiveProviderStatus,
    hasThread: true,
  ...
  const settingsRouteSession = useMemo<ExistingThreadSettingsRouteSession>(
    () => ({
      ...
      usagePresentation,
      onResetProviderContext:
        canResetMissingBobSession && selectedProviderStatus
          ? () => {
          ...
          >
            ...
            >
              <ComposerEditor
                ...
                skills={effectiveProviderStatus?.skills ?? []}
                selection={composerMenu.selection}
