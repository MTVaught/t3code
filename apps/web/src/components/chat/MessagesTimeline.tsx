...
/** Live rows stay static: the tool-call shine animation was removed on purpose. */
function LiveActivityRow({
  ...
  return (
    <div className="min-h-6 w-fit max-w-full min-w-0 rounded-md text-sm leading-relaxed">
      <LiveActivityContent
        label={label}
        iconName={iconName}
        toolIcon={toolIcon}
