...
@@T3_NODE_ENV_SCRIPT@@
STATE_KEY="$1"
STATE_DIR="$HOME/${DEFAULT_TREHER_HOME_DIRECTORY_NAME}/ssh-launch/$STATE_KEY"
DEFAULT_SERVER_HOME="$HOME/${DEFAULT_TREHER_HOME_DIRECTORY_NAME}"
DEFAULT_RUNTIME_FILE="$DEFAULT_SERVER_HOME/${PRODUCTION_STATE_DIRECTORY_NAME}/server-runtime.json"
...
STATE_DIR="$HOME/${DEFAULT_TREHER_HOME_DIRECTORY_NAME}/ssh-launch/@@T3_STATE_KEY@@"
DEFAULT_SERVER_HOME="$HOME/${DEFAULT_TREHER_HOME_DIRECTORY_NAME}"
RUNNER_FILE="$STATE_DIR/run-t3.sh"
mkdir -p "$STATE_DIR"
cat >"$RUNNER_FILE" <<'SH'
